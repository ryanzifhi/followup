...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo $config['web']['url'] ?>home/images/flat-icons/rocket.png">
    <!-- App css -->
        ...
        <div class="navbar-custom">
            ...
            <div class="logo-box">
                <a href="<?php echo $config['web']['url'] ?>" class="logo text-center">
                    <span class="logo-lg">
                        <img src="/home/images/flat-icons/rocket.png" alt="" height="45">
                    </span>
                    <span class="logo-sm">
                        <img src="home/images/flat-icons/rocket.png" alt="" height="40">
                    </span>
                </a>
            </div>
