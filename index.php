...
<meta name="description" content="Panel Sosial Media - Panel Sosmed - Social Media Marketing - SMM Panel terbaik dan termurah se-Indonesia. kami adalah penyedia jasa tambah followers instagram, jasa tambah followers twitter, jasa tambah followers tiktok, jasa tambah subscribers youtube, jasa tambah viewers youtube, jasa tambah followers shopee, jasa tambah followers tokopedia, jasa tambah followers bukalapak, jasa tambah likes instagram, jasa tambah likes fanpage facebook terpercaya dan aman tanpa password. Yuk gabung menjadi Reseller SMM Panel terlengkap dengan pelayanan fast dan responsif">
    ...
    <link rel="icon" href="../home/images/flat-icons/rocket.png">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <img alt="" src="../home/images/flat-icons/rocket.png">
            </a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-8">
                        <div class="site-intro-content">
                            ...
                            <h3>Jasa Kebutuhan Sosial Media</h3>
                            <p class="lead wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                    NASIONAL PEDIA - SMM PANEL Adalah Platform Bisnis Yang Menyediakan Berbagai Kebutuhan Sosial Media Seperti Followers, Likes, Views, Subscribers, Maupun Kebutuhan Sosial Lainnya Dengan Harga Yang Murah Dengan Beberapa Plartform Yang Tersedia Seperti Instagram, Facebook, Twitter, Youtube, Dll.
                            </p>
                            <br />
                            <br />
                    ...
                    <div class="col-lg-3 col-lg-offset-1 col-md-4 hidden-xs hidden-sm">
                        <div class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
                            <img alt="" src="../home/images/flat-icons/rocket.png" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="pricing-table wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                            ...
                            <div class="pricing-price">
                                <p><span class="sup">Rp.</span> <span class="price">350.000-,</span> <span class="sub"></span>
                                </p>
                            </div>
                            <ul class="pricing-feature list-unstyled">
                                <li><span>Operan Website Nasional Pedia</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Domain xyz/my.id/co.id</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Akses Cpanel Website</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Akses Admin Dasboard</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>        
                                <li><span>Full Maintenance</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Auto Deposite Bank/Wallet/Qris</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Full Maintenance</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Costum Menu/Tampilan</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Penghasilan Langsung Ke Rekening</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Atur Harga Layanan</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Akses Website Penuh</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Website Berjalan 24 Jam</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Diajarkan Jika Ada Keliru</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                                <li><span>Terima Jadi</span><span class="main-color-text"><i
                                        class="fa fa-check"></i>
                             </ul>
                            <div class="pricing-btn">
                                <a href="https://api.whatsapp.com/send?phone=<?php echo $data_kontak['whatsapp']; ?>&text=Hallo%20Admin%20Saya%20Mau%20Sewa%20SMM%20Panel%20Nasional%20Pedia" class="appsLand-btn appsLand-btn-gradient"><span>AJUKAN SEWA</span></a>
                            </div>
                        </div>
                    </div>
   <section class="pricing" id="pricing">
                        ...
                        <div class="pricing-table wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                            ...
                            <ul class="pricing-feature list-unstyled">
                                ...
                                <li><span>Add User</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Potongan Harga 10%</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Akses Menu Admin</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Dapat Membuat Kode Voucer</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Mendapat Lencana Verifikasi</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                            </ul>
                            <div class="pricing-btn">
                                <a href="https://api.whatsapp.com/send?phone=<?php echo $data_kontak['whatsapp']; ?>&text=Hallo%20Admin%20Saya%20Mau%20Join%20Reseller%20SMM%Panel%20Nasional%20Pedia" class="appsLand-btn appsLand-btn-gradient"><span>JOIN RESELLER</span></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="pricing-table wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
                            ...
                            <ul class="pricing-feature list-unstyled">
                            	<li><span>Harga Perpanjang Bulanan</span><span>Rp 50.000</span></li>
                                <li><span>Api Integration</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>24/7 Support</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                    ...
                    <div class="col-sm-6">
                        <div class="pricing-table pricing-recommended wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <ul class="pricing-feature list-unstyled">
                                ...
                                <li><span>Add User</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Potongan Harga 40%</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Akses Menu Admin</span><span class="main-color-text"><i
                                        class="fa fa-check"></i></span></li>
                                <li><span>Dapat Membuat Kode Voucer</span><span class="main-color-text"><i
                            ...
                            <div class="pricing-btn">
                                <a href="https://api.whatsapp.com/send?phone=<?php echo $data_kontak['whatsapp']; ?>&text=Hallo%20Admin%20Saya%20Mau%20Join%20Reseller%20SMM%Panel%20Nasional%20Pedia" class="appsLand-btn appsLand-btn-gradient"><span>DAFTAR</span></a>
                            </div>
                        </div>
                    </div>
                </div>
