...
$cek_provider_sosmed = $conn->query("SELECT * FROM provider WHERE code = 'JAGOSOSMED'");
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body table-responsive">
                ...
                <h5 class="m-t-0 text-center text-primary">PROVIDER JAGOSOSMED</h5>
                <?php 
                         $postdata = "api_key=".$data_provider_sosmed['api_key']."&action=profile";
                         $endpoint = "https://www.jagososmed.com/api/profile.php";
	                        ...
	                        curl_setopt($ch, CURLOPT_URL, $endpoint);
                                ...
                                ?>
                <div class="text-dark">                    
                    NAMA : <b> <?php echo $json_result['data']['username']; ?></b><br />
                    SALDO :
                    <b>
                        Rp
                        <?php echo number_format($json_result['data']['balance'],0,',','.'); ?>
                    </b>
                    <br />
                </div>
            </div>
